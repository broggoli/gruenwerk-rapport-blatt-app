class ImageHandler {
    ...
    displayImage(dataUrl, thisElement){
        ...
        const uploadTicketProof = thisElement.parent().parent();
        //display imageFile
        const previewImage = uploadTicketProof.prepend("<img src='"+dataUrl+"' class='imagePreview'/>");

        previewImage.click( (e) => {
                    console.log("open image slideshow!");
        });
    }
